...
public class TestCalendarMaker extends AbsTagMaker { //TODO: extra:"fixed" 차후 필요시 구현 130620 by shkang;
	...
	public TestCalendarMaker(String id, String cssClass, String style, String date, String uri){
	...
	public TestCalendarMaker setDate(String date) {
		this.date = date;
		return this;
	}
	
	public TestCalendarMaker setUri(String uri) {
		this.sUri = uri;
		return this;
	}
	...
	public TestCalendarMaker setCssClass(String cssClass){
	...
	public TestCalendarMaker setExtra(String sExtra){
		if(sExtra == "true"){
			this.extra = "true";
	...
	public TestCalendarMaker setShowBefore(String sShowBefore){
		if(sShowBefore == "true"){
